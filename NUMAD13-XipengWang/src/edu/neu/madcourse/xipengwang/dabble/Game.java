...
public class Game extends Activity{
	...
	private Button ssrButton, pauseButton, hintButton, backButton;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ssrButton = (Button)findViewById(R.id.SingleSR_button);
	...
	class SSRListener implements OnClickListener
	{
