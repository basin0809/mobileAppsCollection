...
public class Introduction extends Activity {
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      setTitle("Rules ");
      introbackButton = (Button)findViewById(R.id.dabble_introback_button);
      introbackButton.setOnClickListener(new IntroBackListener());
   }
   class IntroBackListener implements OnClickListener{
	   @Override
